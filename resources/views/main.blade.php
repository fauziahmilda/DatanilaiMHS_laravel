...
<html lang="en">
  <head>
    ...
    <title>Data Nilai Mahasiswa | Admin Profile</title>
    <!-- Bootstrap -->
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <h3>
                        {{-- @foreach($mahasiswas as $key => $akun)
                          {{  $akun }}
                        @endforeach --}}
                      </h3>
                      ...
                      <ul class="list-unstyled user_data">
                        ...
                        <li>
                        <h2><b>E-mail&nbsp;:</b> {{ Auth()->user()->email }}</h2>
                        </li>
                      </ul>
                      <br />
    ...
    <!-- morris.js -->
    <script src="{{ asset('gentelella-bootstrap/vendors/raphael/raphael.min.js') }}"></script>
    <script src="{{ asset('gentelella-bootstrap/vendors/morris.js/morris.min.js') }}"></script>
